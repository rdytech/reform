require 'reform_126/form/active_model/model_validations'

module Reform126::Form::ActiveModel
  ...
  private
    def active_model_name_for(string)
      return ::ActiveModel::Name.new(OpenStruct.new(:name => string)) if Reform126.rails3_0?

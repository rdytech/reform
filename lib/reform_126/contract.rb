...
require 'reform_126/representer'
...
module Reform126
  ...
  class Contract # DISCUSS: make class?
    ...
    self.representer_class = Reform126::Representer.for(:form_class => self) # only happens in Contract/Form.
    ...
    require 'reform_126/contract/setup'
    include Setup
    ...
    require 'reform_126/contract/validate'
    include Validate
...
require 'reform_126/contract/errors'

...
class CDataBand
  class CData < Representable218::XML::Binding
  ...
  class LonelyRepresenterTest < MiniTest::Spec
    ...
    describe "XML::Collection" do
      describe "with contained objects" do
        representer!(:module => Representable218::XML::Collection)  do
    ...
    describe "XML::AttributeHash" do  # TODO: move to HashTest.
      representer!(:module => Representable218::XML::AttributeHash) do
        self.representation_wrap= :songs
      end
...
class XmlHashTest < MiniTest::Spec
  ...
  describe "plain text" do
    representer!(module: Representable218::XML) do
      hash :songs
    end

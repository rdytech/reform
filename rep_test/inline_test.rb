...
class InlineTest < MiniTest::Spec
  ...
  {
    :hash => [Representable218::Hash, {"songs"=>[{"name"=>"Alive"}]}, {"songs"=>[{"name"=>"You've Taken Everything"}]}],
    :json => [Representable218::JSON, "{\"songs\":[{\"name\":\"Alive\"}]}", "{\"songs\":[{\"name\":\"You've Taken Everything\"}]}"],
  ...
  describe "object pollution" do
    ...
    it "uses an inline decorator and doesn't alter represented" do
      ...
      song.wont_be_kind_of Representable218
    end
  end
  ...
  # for_formats(
  #   :hash => [Representable218::Hash, {"album" => {"artist" => {"label"=>"Epitaph"}}}],
  #   # :xml  => [Representable218::XML, "<open_struct></open_struct>"],
  ...
  for_formats({
    ...
    class ArtistDecorator < Representable218::Decorator
      include Representable218::JSON
      property :label
    end
  ...
  for_formats({
    :hash => [Representable218::Hash, {"song"=>{"name"=>"ALIVE"}}],
    :xml  => [Representable218::XML, "<request>\n  <song>\n    <name>ALIVE</name>\n  </song>\n</request>"],
    :yaml => [Representable218::YAML, "---\nsong:\n  name: ALIVE\n"],
  ...
  describe "define method inline with Decorator" do
    dec = Class.new(Representable218::Decorator) do
      include Representable218::Hash

...
class ConfigTest < MiniTest::Spec
  subject { Representable218::Config.new }
  PunkRock = Class.new
  ...
  describe "#add" do
    describe "returns" do
      it do
        ...
        subject = Representable218::Config.new.add(:title, {:me => true})

        subject.must_be_kind_of Representable218::Definition
  ...
  describe "#remove" do
    ...
    it do
      subject.add(:title, {:me => true})
      subject.add(:genre, {})
      subject.get(:genre).must_be_kind_of Representable218::Definition
  ...
  describe "#inherit!" do
    ...
    it do
      parent = Representable218::Config.new
      ...
      parent.options[:additional_features] = Representable218::Inheritable::Hash[Object => true]
    ...
    it "xx" do
      parent = Representable218::Config.new
      parent.options[:links] = Representable218::Inheritable::Array.new
      parent.options[:links] << "//1"

      subject.options[:links] = Representable218::Inheritable::Array.new

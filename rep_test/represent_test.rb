...
class RepresentTest < MiniTest::Spec
  ...
  for_formats(
    :hash => [Representable218::Hash, out=[{"name" => "Days Go By"}, {"name"=>"Can't Take Them All"}], out],
    :json => [Representable218::JSON, out="[{\"name\":\"Days Go By\"},{\"name\":\"Can't Take Them All\"}]", out],
    # :xml  => [Representable218::XML,  out="<a><song></song><song></song></a>", out]
    ...
    describe "Decorator#to_/from_#{format}" do
      let (:format) { format }
      let (:representer) {
        Class.new(Representable218::Decorator) do
          include mod
          property :name
  ...
  for_formats(
    :hash => [Representable218::Hash, out={"name" => "Days Go By"}, out],
    :json => [Representable218::JSON, out="{\"name\":\"Days Go By\"}", out],
    # :xml  => [Representable218::XML,  out="<a><song></song><song></song></a>", out]
  ) do |format, mod, output, input|

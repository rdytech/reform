...
module JsonTest
  class APITest < MiniTest::Spec
    Json = Representable218::JSON
    Def = Representable218::Definition
    ...
    describe "JSON module" do
      ...
      describe "#build_for" do
        it "returns TextBinding" do
          assert_kind_of Representable218::Hash::Binding, Representable218::Hash::Binding.build_for(Def.new(:band), nil, nil)
        end

        it "returns HashBinding" do
          assert_kind_of Representable218::Hash::Binding::Hash, Representable218::Hash::Binding.build_for(Def.new(:band, :hash => true), nil, nil)
        end

        it "returns CollectionBinding" do
          assert_kind_of Representable218::Hash::Binding::Collection, Representable218::Hash::Binding.build_for(Def.new(:band, :collection => true), nil, nil)
        end
      end

      # describe "#representable_bindings_for" do
      #   it "returns bindings for each property" do
      #     bins = @band.send(:representable_bindings_for, Representable218::JSON::Binding, {})
  ...
  class HashTest < MiniTest::Spec
    describe "hash :songs" do
      representer!(:module => Representable218::JSON) do
        hash :songs
      end
    ...
    describe "hash :songs, :class => Song" do
      representer!(:module => Representable218::JSON) do
        hash :songs, :extend => Module.new { include Representable218::JSON; property :name }, :class => Song
      end

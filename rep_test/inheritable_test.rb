...
class ConfigInheritableTest < MiniTest::Spec
  ...
  # Inheritable::Array
  it do
    parent = Representable218::Inheritable::Array.new([1,2,3])
    child  = Representable218::Inheritable::Array.new([4])

    child.inherit!(parent).must_equal([4,1,2,3])
  end

  # Inheritable::Hash
  Inheritable = Representable218::Inheritable
  describe "Inheritable::Hash" do
    it do
      parent = Inheritable::Hash[
        :volume => volume = Uber::Options::Value.new(9),
        :genre  => "Powermetal",
        :only_parent => only_parent = Representable218::Inheritable::Array["Pumpkin Box"],
        :in_both     => in_both     = Representable218::Inheritable::Array["Roxanne"],
        :hash => {:type => :parent},
      ...
      child  = Inheritable::Hash[
        :genre => "Metal",
        :pitch => 99,
        :in_both => Representable218::Inheritable::Array["Generator"],
        :hash => {:type => :child},
    ...
    it do
      parent = Inheritable::Hash[
        :details => Inheritable::Hash[
          ...
          :length => length = Representable218::Definition.new(:length) # Cloneable.
      ]]

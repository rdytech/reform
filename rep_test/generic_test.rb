...
class GenericTest < MiniTest::Spec # TODO: rename/restructure to CollectionTest.
  ...
  let (:song_representer) { Module.new do include Representable218::Hash; property :title end  }
  ...
  describe "::collection" do
    ...
    for_formats(
      :hash => [Representable218::Hash, {"songs" => []}],
      #:xml  => [Representable218::XML, "<open_struct><songs/></open_struct>"],
      :yaml => [Representable218::YAML, "---\nsongs: []\n"],
    ) do |format, mod, output, input|

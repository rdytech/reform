...
class TwinDisposableTest < MiniTest::Spec
  module Model
  ...
  module Twin
    class Album < Disposable009::Twin
...
require 'disposable009/twin/struct'
...
class TwinBuilderTest < MiniTest::Spec
  ...
  describe "without property setup" do
    class Host
      include Disposable009::Twin::Builder
